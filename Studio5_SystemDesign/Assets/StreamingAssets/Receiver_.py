...
def print_data():
    ...
    global data_from_port1, data_from_port2, knob_mode,previous_knob_mode,previous_knob_data
    while True:
        with lock:
...
def main():
    ...
    # port1 = '/dev/cu.wchusbserial11230'  # Replace with your actual serial port
    # port2 = '/dev/cu.wchusbserial11240'  # Replace with your actual serial port
